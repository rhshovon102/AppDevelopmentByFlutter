...
class _student_management_systemState extends State<student_management_system> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Center(child: Text("StudentManagement",style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold, fontFamily: 'Aclonica'),)),backgroundColor: Colors.red,),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        GestureDetector(
                          onTap: (){
                            launchUrlString("https://github.com/rakibhasan3948/Student-Management-System-using-Java-Language");
                          },
