...
class _aboutState extends State<about> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Center(child: Text("Rakib Hasan",style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold,fontFamily: 'Aclonica'),)),backgroundColor: Colors.red,),
