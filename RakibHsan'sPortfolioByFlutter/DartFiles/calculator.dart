...
class _calculatorState extends State<calculator> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Center(child: Text("Calculator",style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold, fontFamily: 'Aclonica'),)),backgroundColor: Colors.red,),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        GestureDetector(
                          onTap: (){
                            launchUrlString("https://github.com/rakibhasan3948/Calculator-Shell-Scripting");
                          },
