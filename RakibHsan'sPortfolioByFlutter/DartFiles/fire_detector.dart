...
class _fire_detectorState extends State<fire_detector> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Center(child: Text("Fire Detector",style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold, fontFamily: 'Aclonica'),)),backgroundColor: Colors.red,),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        GestureDetector(
                          onTap: (){
                            launchUrlString("https://github.com/rakibhasan3948/Fire-Detection-System-using-Arduino-Nano-and-Flame-Sensor");
                          },
