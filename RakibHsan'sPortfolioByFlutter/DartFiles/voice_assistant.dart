...
class _voice_assistantState extends State<voice_assistant> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Center(child: Text("Voice Assistant",style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold, fontFamily: 'Aclonica'),)),backgroundColor: Colors.red,),
