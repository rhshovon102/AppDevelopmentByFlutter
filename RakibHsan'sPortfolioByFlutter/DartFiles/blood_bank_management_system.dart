...
class _blood_bank_management_systemState extends State<blood_bank_management_system> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Center(child: Text("BloodManagement",style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold, fontFamily: 'Aclonica'),)),backgroundColor: Colors.red,),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        GestureDetector(
                          onTap: (){
                            launchUrlString("https://github.com/rakibhasan3948/Blood-Bank-Management-System-Algorithm-Project-1-used-C-Programming-Language-");
                          },
