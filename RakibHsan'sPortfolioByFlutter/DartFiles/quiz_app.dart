...
class _quiz_appState extends State<quiz_app> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Center(child: Text("Quiz App",style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold, fontFamily: 'Aclonica'),)),backgroundColor: Colors.red,),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        GestureDetector(
                          onTap: (){
                            launchUrlString("https://github.com/rakibhasan3948/Quiz-Application-Android");
                          },
